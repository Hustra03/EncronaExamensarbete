...
public class finalYearlyWaterHeatingConsumption extends componentAbstract<List<Map.Entry<Integer,List<heatingEnergySource>>>>{
    /**
     ...
     */
    public finalYearlyWaterHeatingConsumption(String name, String unit, Map<String,componentAbstract> dependsOn, List<modifierAbstract<List<Entry<Integer, List<heatingEnergySource>>>>> modifiers)
    {   this.setName(name);
        this.setUnit(unit);
    ...
    public void calculate() throws Exception {
        ...
        improvementImpacts.removeIf((improvement)->{return !(improvement.getKey().getImpactType().equals(improvementImpactEnum.Water));});
