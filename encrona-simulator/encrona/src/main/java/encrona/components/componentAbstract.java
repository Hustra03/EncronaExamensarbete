 ...
 */
public abstract class componentAbstract<T> implements componentInterface<T> {
    ...
    private Map<String,? extends componentAbstract> dependsOn; //TODO test if this works, does give a warning but if parameterized then only those with the same value as the instance can be added

    //https://docs.oracle.com/javase/8/docs/api/java/util/Map.html 
    private List<? extends modifierAbstract<T>> modifiers; //This should be parameterized, since only modifiers which are for the same data type as value should be accepted
     ...
     */
    public Map<String,? extends componentAbstract> getDependsOn()
    {
        return dependsOn;
    }
     ...
     */
    public void setDependsOn(Map<String,? extends componentAbstract> newDependsOn)
    {
     ...
     */
    public List<? extends modifierAbstract<T>> getModifiers()
    {
        return modifiers;
    }
     ...
     */
    public void setModifiers(List<? extends modifierAbstract<T>> newModifiers)
    {
    ...
    /**
     * This method applies each of the modifiers to the current value of the component
